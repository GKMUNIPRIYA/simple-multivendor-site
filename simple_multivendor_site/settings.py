...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-(w0xd82mx=l#v^w)83zhzwc&))6#+9&#e(87y7a8mo=)6!=vz8')
...
STRIPE_SECRET_KEY = 'sk_test_placeholder' # For Django Backend
